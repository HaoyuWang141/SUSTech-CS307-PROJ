...
public class LocalJudge {
    ...
    public static String database = "localhost:5432/project2";

    public static String root = "postgres";

    public static String pass = "111111";

    public static String recordsCSV = "./data/records.csv";

    public static String staffsCSV = "./data/staffs.csv";
    ...
    public static String answerDirectory = "./localAnswerSerFiles/";

    public static SUSTCDepartmentManagerUserTest sustcDepartmentManagerUserTest = null;

    public static CompanyManagerUserTest companyManagerUserTest = null;

    public static CourierUserTest courierUserTest = null;

    public static SeaportOfficerUserTest seaportOfficerUserTest = null;

    public static LogInfo logInfo = new LogInfo("Hua Hang", LogInfo.StaffType.SustcManager, "500622842781782190");
    ...
    public void newItem() {
        ...
        for (Map.Entry<List<Object>, Boolean> entry : treeSet) {
            List<Object> params = entry.getKey();
            boolean flag = manipulation.newItem((LogInfo) params.get(0), (ItemInfo) params.get(1));
            assertEquals(entry.getValue(), flag);
        }
