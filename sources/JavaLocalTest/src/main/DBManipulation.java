...
public class DBManipulation implements IDatabaseManipulation {
    public static String recordsCSV = "data/test_records.csv";
    public static String staffsCSV = "./data/test_staffs.csv";
    ...
    public DBManipulation(String database, String root, String pass) {
        ...
        try {
            ...
            URL u1 = DBManipulation.class.getResource("/sql/1_DDL.sql");
            URL u2 = DBManipulation.class.getResource("/sql/2_trigger.sql");
            URL u3 = DBManipulation.class.getResource("/sql/3_authority.sql");
            String sql_DDL = readFile(u1.getPath());
            String sql_trigger = readFile(u2.getPath());
            String sql_authority = readFile(u3.getPath());
