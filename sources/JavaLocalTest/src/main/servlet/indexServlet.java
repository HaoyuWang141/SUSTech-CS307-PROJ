...
import static main.DBManipulation.*;
import static main.util.PostgresqlUtil.*;

@WebServlet("/indexServlet")
public class indexServlet extends HttpServlet {
    private static InputStream in = Objects.requireNonNull(indexServlet.class.getClassLoader().getResourceAsStream("test_records.csv"));
